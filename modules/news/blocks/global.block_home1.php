...
if (!nv_function_exists('nv_block_home1')) {
    /**
     * nv_block_config_home1()
     *
     * @param string $module
     ...
     * @return string
     */
    function nv_block_config_home1($module, $data_block, $lang_block)
    {
    ...
    /**
     * nv_block_config_home1_submit()
     *
     * @param string $module
     * @param array  $lang_block
     * @return array
     */
    function nv_block_config_home1_submit($module, $lang_block)
    {
        global $nv_Request;
        $return = [];
        $return['error'] = [];
     ...
     * @return string|void
     */
    function nv_block_home1($block_config)
    {
        ...
        if (!empty($listleft)) {
            if (file_exists(NV_ROOTDIR . '/themes/' . $global_config['module_theme'] . 'modules/' . $mod_file . '/block_home1.tpl')) {
                $block_theme = $global_config['module_theme'];
            } else {
                $block_theme = 'default';
            }
            $xtpl = new XTemplate('block_home1.tpl', NV_ROOTDIR . '/themes/' . $block_theme . '/modules/' . $mod_file);
...
if (defined('NV_SYSTEM')) {
    ...
    if (isset($site_mods[$module])) {
        ...
        $content = nv_block_home1($block_config);
    }
}
